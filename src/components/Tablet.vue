<template>
  <div class="container-center-horizontal">
    <div class="tablet screen">
      ...
      />
      <component183 />
      <div class="thetas-nativedecen-3 montserrat-semi-bold-white-70px" v-html="thetaSNativeDecen"></div>
      <div class="choco-is-building-ba-3 montserrat-normal-white-20px" v-html="chocoIsBuildingBa"></div>
      <div class="flex-row-4">
        <img class="bar2-6" :src="bar21" /><component173
      ...
      <div class="how-to-participate-3 montserrat-semi-bold-white-63px">{{ howToParticipate }}</div>
      <div class="overlap-group7-3">
        <component111
        ...
        />
        <img class="bar1-9" :src="bar11" /><img class="bar1-10" :src="bar12" /><img class="bar1-11" :src="bar13" />
      </div>
      <div class="overlap-group8-3" :style="{ 'background-image': 'url(' + overlapGroup8 + ')' }">
        <img class="bar2-7" :src="bar22" /><component201
