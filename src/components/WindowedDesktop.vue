<template>
  <div class="container-center-horizontal">
    <div class="windowed-desktop screen">
      <div class="flex-row-1">
        <div class="overlap-group9-1" :style="{ 'background-image': 'url(' + overlapGroup9 + ')' }">
          <img class="chocolate-bar_1f36b-11" :src="chocolateBar_1F36B" />
        </div>
        <div class="overlap-group-21">
          <div class="choco-11 montserrat-black-white-32px">{{ choco }}</div>
          <div class="finance-11 montserrat-black-white-14px">{{ finance }}</div>
        </div>
        <component161
      ...
      <div class="flex-row-2">
        <div class="flex-col-8">
          <div class="thetas-nativedecen-1 montserrat-semi-bold-white-70px" v-html="thetaSNativeDecen"></div>
          <div class="choco-is-building-ba-1 montserrat-normal-white-20px" v-html="chocoIsBuildingBa"></div>
          <component173
            :component411Props="component173Props.component411Props"
            :component412Props="component173Props.component412Props"
          />
        </div>
        <img class="fallingchoco-1" :src="fallingchoco" />
      </div>
        ...
        <div class="overlap-group11-1">
          <div class="overlap-group-container-2">
            <div class="overlap-group9-2">
              <div class="how-to-participate-1 montserrat-semi-bold-white-70px">{{ howToParticipate }}</div>
            ...
            <div class="overlap-group7-1">
              ...
              />
              <img class="bar1-4" :src="bar12" />
            </div>
          </div>
          <img class="bar2-2" :src="bar21" />
        </div>
        <div class="overlap-group8-1">
          <div class="rectangle-2-1"></div>
          <img class="bar1-5" :src="bar13" /><img class="bar2-3" :src="bar22" /><component221
