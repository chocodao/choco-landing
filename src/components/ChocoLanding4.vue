<template>
  <div class="container-center-horizontal">
    <div class="choco-landing-4 screen">
      <component161
      ...
      <div class="thetas-nativedecen-10 montserrat-semi-bold-white-70px" v-html="thetaSNativeDecen"></div>
      <div class="choco-is-building-ba-10 montserrat-normal-white-20px" v-html="chocoIsBuildingBa"></div>
      <div class="overlap-group7-11">
        <component173
        ...
        />
        <img class="bar2-20" :src="bar21" />
      </div>
      <div class="how-to-participate-10 montserrat-semi-bold-white-63px">{{ howToParticipate }}</div>
      <div class="overlap-group8-10">
        <component111
        ...
        />
        <img class="bar1-30" :src="bar11" /><img class="bar1-31" :src="bar12" /><img class="bar1-32" :src="bar13" />
      </div>
      <div class="overlap-group6-2" :style="{ 'background-image': 'url(' + overlapGroup6 + ')' }">
        <img class="bar2-21" :src="bar22" /><component193
